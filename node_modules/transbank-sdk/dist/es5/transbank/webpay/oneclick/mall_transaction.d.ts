...
declare class MallTransaction extends BaseTransaction {
     ...
     */
    authorize(username: string, tbkUser: string, parentBuyOrder: string, details: Array<TransactionDetail>): Promise<any>;
    /**
     * Obtain the status of a specific transaction
     * @param buyOrder Child transaction buy order
     */
    status(buyOrder: string): Promise<any>;
    /**
     ...
     */
    refund(buyOrder: string, childCommerceCode: string, childBuyOrder: string, amount: number): Promise<any>;
    /**
     ...
     */
    capture(childCommerceCode: string, childBuyOrder: string, authorizationCode: string, captureAmount: number): Promise<any>;
}
