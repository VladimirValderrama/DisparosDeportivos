...
declare class Inscription extends BaseTransaction {
    /**
     ...
     */
    start(url: string, name: string, lastName: string, secondLastName: string, rut: string, serviceId: string, finalUrl: string, maxAmount: number, phone: string, cellPhone: string, patpassName: string, personEmail: string, commerceEmail: string, address: string, city: string): Promise<any>;
    /**
