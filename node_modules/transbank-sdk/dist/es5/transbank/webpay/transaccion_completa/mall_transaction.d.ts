import Options from 'transbank-sdk/dist/es5/transbank/common/options';
import InstallmentDetail from 'transbank-sdk/dist/es5/transbank/webpay/common/installments_detail';
import TransaccionCompletaCommitDetail from 'transbank-sdk/dist/es5/transbank/webpay/transaccion_completa/common/commit_detail';
import TransactionDetail from 'transbank-sdk/dist/es5/transbank/webpay/common/transaction_detail';
import BaseTransaction from 'transbank-sdk/dist/es5/transbank/common/base_transaction';
declare class MallTransaction extends BaseTransaction {
     ...
     */
    create(buyOrder: string, sessionId: string, cardNumber: string, cardExpirationDate: string, details: Array<TransactionDetail>, cvv: number | undefined): Promise<any>;
    /**
     ...
     */
    installments(token: string, details: Array<InstallmentDetail>): Promise<any[]>;
    /**
     * Commit a transaction
     * @param token Unique transaction identifier
     * @param details Child transactions details, see {@link CommitDetail} for more information.
     */
    commit(token: string, details: Array<TransaccionCompletaCommitDetail>): Promise<any>;
    /**
     ...
     */
    capture(token: string, commerceCode: string, buyOrder: string, authorizationCode: string, captureAmount: number): Promise<any>;
}
